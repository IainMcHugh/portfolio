...
let projects = {
  names: {
    TRP: {
      ...
      desktopMobile: true,
      description: "An extensive Website created for the Tallaght Rehabiliation Center using ReactJS.",
    ...
    Covid19Tracker: {
      ...
      live: "#",
      desktopMobile: true,
      description: "Web Application for visualising Covid19 statistics using an API",
      status: "(Complete)"
    },
    HungryFrontend: {
      ...
      live: "#",
      desktopMobile: true,
      description: "Fullstack project aimed at bringing restaurant menus online, as well as providing a CMS for restaurants",
      status: "(Under Development)"
    },
    HungryBackend: {
    ...
    Clymbr: {
      ...
      desktopMobile: false,
      description: "Android app that provides a visual mapping of climbing gyms and allows climbers to track the progress of their climbs",
      status: "(Complete)"
    },
    MWLoadouts: {
      ...
      desktopMobile: false,
      description: "Flutter app that allows users to recreate their Call of Duty Weapon Classes down to each individual attachment. Can search and share Classes with friends",
      status: "(Complete)"
    },
    VidQuiz: {
      ...
      live: "#",
      desktopMobile: true,
      description: "A simple quiz site that allows users to create and complete quizzes of their favourite Youtube videos, designed entirely with PHP/SQL",
      status: "(Complete)"
    },
    Programa: {
      ...
      live: "#",
      desktopMobile: true,
      description: "Expansive Web Application that allows users to create, schedule, and complete workouts, tracking their sets, reps, and weights used. Designed with ReactJS/Firebase",
      status: "(Complete)"
    },
  },
  technologies: {
